...
위 그림에서는 PK를 part_id로 갖고 PFK로 pc)id로 갖음
...
<p align="center">
  <img src="./../../assets/images/2023-09-26-Erd/s1.png" align="center" width="45%">
  <span style="margin: 20px;"></span> <!-- 간격을 조절할 span 요소 추가 -->
  <img src="./../../assets/images/2023-09-26-Erd/s2.png" align="center" width="45%">
  <figcaption align="center">마지막 2개는 generalization대신 specialization이 들어가도 되는듯 함</figcaption>
</p>
